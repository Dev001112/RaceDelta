...
export default function SeasonSelector() {
    ...
    return (
        <div className="flex items-center gap-3">
            {isLive && (
                <div className="hidden sm:flex items-center gap-1.5 px-2 py-0.5 rounded-full bg-emerald-500/10 border border-emerald-500/20 text-emerald-400 text-[10px] font-bold tracking-wider uppercase">
