...
export default function Navbar() {
  ...
  return (
    <header className="sticky top-0 z-50 bg-[#0d0f11] border-b border-[#22272c]">
      <div className="container">
        <nav className="flex h-16 items-center justify-between gap-4">
          <Link to="/" className="flex items-center gap-3 min-w-fit">
            <div className="h-9 w-9 bg-[#ff1801] text-white grid place-items-center font-black italic text-lg font-broadcast">
              RD
            </div>
        ...
        <div className="md:hidden flex gap-1 overflow-x-auto border-t border-[#22272c] py-2">
